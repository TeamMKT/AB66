...
public class TC006_Amazon_Fresh 
{
  @Test
  public void fresh() throws InterruptedException
  {
	  ...
	  Assert.assertTrue(fresh.isDisplayed(),"Sorry- fresh is not dipayed");
	  /*Actions a1 = new Actions(driver);
		 a1.moveToElement(fresh).perform();
		 Thread.sleep(3000);
	
		 
	WebElement fresh1 = driver.findElement(By.xpath("//img[@alt='Amazon Fresh']"));
	fresh1.click();
	Thread.sleep(3000);*/
