...
public class TC0012_Amazon_SearchBox 
{
	@Test
	...
	//Assert.assertEquals(searchbox.getAttribute("value").equals("Shoes"), true,"Sorry-Search box value mismatch");
	
	String actutaltext = searchbox.getAttribute("value");
	Assert.assertEquals(actutaltext,"Shoes","Sorry-Search box value mismatch");
