...
public class TC0014_Amazon_ReturnsAndOrders
{
	@Test
	...
	// WebElement returnsandorders = driver.findElement(By.xpath("//a[@id='nav-orders']"));
	 WebElement returnsOrders = driver.findElement(By.xpath("//span[text()='Returns']"));
	 returnsOrders.click();
	 Thread.sleep(3000);
	 
	 WebElement returnsOrderstext = driver.findElement(By.xpath("//h1[text()='Your Orders']"));
	 Assert.assertEquals(returnsOrderstext.getText(),"Your Orders","Soory did not match the condition");
