...
public class TC008_Amazon_AmazonPay 
{
	@Test
	...
	WebElement pay = driver.findElement(By.xpath("//a[text()='Amazon Pay']"));
			...
			WebElement pay1 = driver.findElement(By.xpath("//div[@class='a-column a-span8 a-text-left']/span"));
			Assert.assertEquals(pay1.getText(), "Amazon Pay Balance","Sorry Amazon Pay blance not diplayed");	  
