/*"WAP  to launch cleartrip.com->close the pop up->Enter from->Enter To->(BLR TO DEL)->Click on Calender
->Click on right arrow[it will take you to the next month]->Click on any date based on above XPATH"	*/					
