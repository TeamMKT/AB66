...
public class Demo_Practise_DDT 
{
@DataProvider(name = "values")
	public Object [][] values() throws Throwable
	{
		...
		for(int i=0;i<3;i++)
		{
			for(int j=0;j<2;j++)
			{
				data[i][j]=wb.getSheet("Logindetails_Demo").getRow(i).getCell(j).getStringCellValue();
			}
		}
		return data;
}
...
Thread.sleep(3000);
WebElement w1 = driver.findElement(By.name("user-name"));
w1.sendKeys(UN);
